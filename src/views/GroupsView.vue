...
import { ChevronUp, ChevronDown, ChevronsUpDown, UserMinus, Pencil } from 'lucide-vue-next'
...
function saveEditName() {
  if (!editingGroup.value || !editName.value.trim()) return
  editingGroup.value.name = editName.value.trim()
