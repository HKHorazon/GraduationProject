...
CLASSES = ["甲", "乙"]
CATEGORIES = ["主視覺", "多媒體", "遊戲", "網紅直播", "平面設計", "其他"]
...
NEW_GROUPS = [
    ("g9",  1, "校園活動報名系統", "多媒體",   "114", ["t6"]),
    ("g10", 2, "AI 履歷健檢工具",  "主視覺",   "114", ["t7", "t1"]),
    ("g11", 3, "智慧停車場管理",   "其他",     "114", ["t8"]),
    ("g12", 4, "校園社群論壇",     "網紅直播", "114", ["t9"]),
    ("g13", 5, "釣魚信件偵測平台", "其他",     "114", ["t10", "t2"]),
    ("g14", 1, "2D 像素冒險遊戲",  "遊戲",     "115", ["t6", "t7"]),
    ("g15", 2, "個人化課程推薦",   "多媒體",   "115", ["t8"]),
    ("g16", 3, "IoT 溫室監控",     "其他",     "115", ["t9"]),
]
