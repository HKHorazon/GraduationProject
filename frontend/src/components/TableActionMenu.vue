      ...
      >
        <button
          ...
          :class="action.disabled
            ...
            : action.danger
              ? 'text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 cursor-pointer'
        ...
        <div v-if="actions.length === 0" class="px-3 py-2 text-xs text-slate-600 dark:text-slate-400">
          暫無可用操作
        </div>
      </div>
    </Transition>
